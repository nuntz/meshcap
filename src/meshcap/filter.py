...
class FilterParser:
    ...
    def _handle_operator(self, token: str, operator_stack: List[str], output_queue: List[Any]):
        ...
        if token == 'node':
            ...
            if token == 'is':
                ...
                if next_token == 'encrypted':
                    ...
                    raise FilterError(f"'is' must be followed by 'encrypted' or 'plaintext', got '{next_token}'")
...
class FilterEvaluator:
    ...
    def evaluate_rpn(self, rpn_stack: List[Union[Tuple[str, str, str], str]], 
                     packet: Dict[str, Any], interface: Any = None) -> bool:
        ...
        if len(eval_stack) != 1:
            raise FilterError("Invalid expression - evaluation stack should contain exactly one result")
        
        return eval_stack[0]
    
    def _evaluate_primitive(self, primitive: Tuple[str, str, str], packet: Dict[str, Any], interface: Any = None) -> bool:
    ...
    def _eval_node(self, field: str, value: str, packet: Dict[str, Any]) -> bool:
        ...
        if field == 'src':
            ...
            return from_id == value or to_id == value
        
        return False
    
    def _eval_user(self, field: str, value: str, packet: Dict[str, Any], interface: Any) -> bool:
...
def evaluate_filter(rpn_stack: List[Union[Tuple[str, str, str], str]], 
                   packet: Dict[str, Any], interface: Any = None) -> bool:
