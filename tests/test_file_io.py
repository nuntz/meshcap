...
def test_file_io_integration():
    ...
    try:
        ...
        with patch.object(sys, 'argv', ['meshcap', '--read-file', temp_filename]), \
...
def test_read_nonexistent_file():
    ...
    with patch.object(sys, 'argv', ['meshcap', '--read-file', '/nonexistent/file.pkl']), \
...
def test_no_resolve_with_none_interface():
    ...
    assert "!12345678→!87654321" in formatted
